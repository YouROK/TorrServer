...
func RouteWebPages(route *gin.RouterGroup) {
	...
	route.GET("/static/js/main.156908fe.chunk.js.map", func(c *gin.Context) {
		c.Data(200, "application/json", Staticjsmain156908fechunkjsmap)
	})
	...
	route.GET("/static/js/main.156908fe.chunk.js", func(c *gin.Context) {
		c.Data(200, "application/javascript", Staticjsmain156908fechunkjs)
	})

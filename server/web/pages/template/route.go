...
func RouteWebPages(route *gin.RouterGroup) {
	...
	route.GET("/static/js/main.3201470a.chunk.js.map", func(c *gin.Context) {
		c.Data(200, "application/json", Staticjsmain3201470achunkjsmap)
	})
	...
	route.GET("/static/js/main.3201470a.chunk.js", func(c *gin.Context) {
		c.Data(200, "application/javascript", Staticjsmain3201470achunkjs)
	})

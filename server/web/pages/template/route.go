...
func RouteWebPages(route *gin.RouterGroup) {
	...
	route.GET("/static/js/main.0c2bd164.chunk.js", func(c *gin.Context) {
		c.Data(200, "application/javascript", Staticjsmain0c2bd164chunkjs)
	})
	...
	route.GET("/static/js/main.0c2bd164.chunk.js.map", func(c *gin.Context) {
		c.Data(200, "application/json", Staticjsmain0c2bd164chunkjsmap)
	})

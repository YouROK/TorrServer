...
func RouteWebPages(route *gin.RouterGroup) {
	...
	route.GET("/static/js/2.f70c24c3.chunk.js.LICENSE.txt", func(c *gin.Context) {
		c.Data(200, "text/plain; charset=utf-8", Staticjs2f70c24c3chunkjsLICENSEtxt)
	})
	...
	route.GET("/static/js/main.503e8a33.chunk.js", func(c *gin.Context) {
		c.Data(200, "application/javascript", Staticjsmain503e8a33chunkjs)
	})
	...
	route.GET("/static/js/2.f70c24c3.chunk.js.map", func(c *gin.Context) {
		c.Data(200, "application/json", Staticjs2f70c24c3chunkjsmap)
	})
	...
	route.GET("/static/js/2.f70c24c3.chunk.js", func(c *gin.Context) {
		c.Data(200, "application/javascript", Staticjs2f70c24c3chunkjs)
	})


	route.GET("/static/js/main.503e8a33.chunk.js.map", func(c *gin.Context) {
		c.Data(200, "application/json", Staticjsmain503e8a33chunkjsmap)
	})

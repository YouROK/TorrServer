...
func RouteWebPages(route *gin.RouterGroup) {
	...
	route.GET("/static/js/main.b188e1dd.chunk.js", func(c *gin.Context) {
		c.Data(200, "application/javascript; charset=utf-8", Staticjsmainb188e1ddchunkjs)
	})

	route.GET("/static/js/main.b188e1dd.chunk.js.map", func(c *gin.Context) {
		c.Data(200, "application/json", Staticjsmainb188e1ddchunkjsmap)
	})

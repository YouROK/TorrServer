...
func RouteWebPages(route gin.IRouter) {
	...
	route.GET("/static/js/main.f6532abb.chunk.js", func(c *gin.Context) {
		etag := fmt.Sprintf("%x", md5.Sum(Staticjsmainf6532abbchunkjs))
		c.Header("Cache-Control", "public, max-age=31536000")
		c.Header("ETag", etag)
		c.Data(200, "application/javascript; charset=utf-8", Staticjsmainf6532abbchunkjs)
	})

	route.GET("/static/js/main.f6532abb.chunk.js.map", func(c *gin.Context) {
		etag := fmt.Sprintf("%x", md5.Sum(Staticjsmainf6532abbchunkjsmap))
		c.Header("Cache-Control", "public, max-age=31536000")
		c.Header("ETag", etag)
		c.Data(200, "application/json", Staticjsmainf6532abbchunkjsmap)
	})
